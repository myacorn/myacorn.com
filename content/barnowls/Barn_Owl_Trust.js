...
Ext.onReady(function() {
	...
	var tree = new Ext.tree.TreePanel({
		...
		root: new Ext.tree.AsyncTreeNode({
		    ...
		    {
			text: 'Where are you likely to find Barn Owls?',
			id: "video1",
			expanded: true,
			leaf: false,
			children: [{
				...
				{
				text: 'Roosting and nesting sites',
				id: "video1-2",
				leaf: true
				},
				{
			...
			children: [{
		      ...
		      {
			text: 'Providing a home for Barn Owls',
			id: "video5",
			expanded: true,
			leaf: false,
			children: [{
				...
				{
				text: 'Nest box installation safety', //123 seconds
				id: "video5-2",
				leaf: true
				}
			]
